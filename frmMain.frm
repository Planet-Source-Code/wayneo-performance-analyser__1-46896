...
Private Sub cmdExecute_Click()
    ...
    For i = 0 To 3
        If chkEnableTest(i).Value = Checked Then
            ...
            lvwitem.SubItems(1) = Times(i).lTotalTime & " 탎"
            lvwitem.SubItems(2) = Times(i).lTotalTime / lMaxIterations & " 탎"
            lvwitem.SubItems(3) = Times(i).lBestTime & " 탎"
            lvwitem.SubItems(4) = Times(i).lWorstTime & " 탎"
